...
<body class="h-full font-[Inter] antialiased bg-gray-50" x-data="{ sidebarOpen: false, sidebarCollapsed: localStorage.getItem('sidebarCollapsed') === 'true' }" x-init="$watch('sidebarCollapsed', v => localStorage.setItem('sidebarCollapsed', v))">
    ...
    <aside
        ...
        class="fixed inset-y-0 left-0 z-50 flex flex-col w-64 bg-gradient-to-b from-indigo-900 via-indigo-800 to-blue-900 transform transition-all duration-200 ease-in-out"
    >
        {{-- Sidebar header --}}
        <div class="flex items-center gap-3 px-3 py-5 border-b border-white/10" :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : 'px-5'">
            @if($logoInstansi)
                <div class="flex items-center justify-center w-10 h-10 rounded-xl bg-white/15 backdrop-blur-sm overflow-hidden shrink-0">
                    <img src="{{ $logoInstansi }}" alt="Logo" class="w-8 h-8 object-contain">
                </div>
            @else
                <div class="flex items-center justify-center w-10 h-10 rounded-xl bg-white/15 backdrop-blur-sm shrink-0">
            ...
            @endif
            <div class="min-w-0 flex-1" x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity duration-100" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
            ...
            {{-- Close button mobile --}}
            <button @click="sidebarOpen = false" class="ml-auto lg:hidden text-white/70 hover:text-white shrink-0">
                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                </svg>
            </button>
            {{-- Collapse toggle desktop --}}
            <button @click="sidebarCollapsed = !sidebarCollapsed" class="hidden lg:flex items-center justify-center w-6 h-6 text-white/60 hover:text-white transition-colors shrink-0" :class="sidebarCollapsed ? 'mx-auto' : 'ml-auto'">
                <svg class="w-4 h-4 transition-transform duration-200" :class="sidebarCollapsed ? 'rotate-180' : ''" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <nav class="flex-1 py-4 space-y-1 overflow-y-auto" :class="sidebarCollapsed ? 'px-2' : 'px-3'">
            ...
            <a href="{{ route('dashboard') }}"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Dashboard</span>
            </a>
            @endcan

            {{-- Absensi Group --}}
            @if(auth()->user()->hasAnyPermission(['absensi.view','hasil-absensi.view','rekap.view','rekap-manual.view','surat-izin.view']))
            <p class="px-3 mt-4 mb-2 text-xs font-semibold tracking-wider text-indigo-300 uppercase" x-show="!sidebarCollapsed">Absensi</p>
            @endif

            {{-- Input Absensi --}}
            @can('absensi.view')
            <a href="{{ route('absensi') }}"
               :title="sidebarCollapsed ? 'Input Absensi' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Input Absensi</span>
            </a>
            @endcan
            ...
            <a href="{{ route('hasil-absensi') }}"
               :title="sidebarCollapsed ? 'Hasil Absensi' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Hasil Absensi</span>
            </a>
            @endcan
            ...
            <a href="{{ route('rekap.absensi') }}"
               :title="sidebarCollapsed ? 'Rekap & Download' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Rekap & Download</span>
            </a>
            @endcan
            ...
            <a href="{{ route('rekap-manual.index') }}"
               :title="sidebarCollapsed ? 'Upload Rekap Manual' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Upload Rekap Manual</span>
            </a>
            @endcan
            ...
            <a href="{{ route('surat-izin.index') }}"
               :title="sidebarCollapsed ? 'Surat Izin & Sakit' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Surat Izin & Sakit</span>
            </a>
            @endcan
            ...
            <p class="px-3 mt-4 mb-2 text-xs font-semibold tracking-wider text-indigo-300 uppercase" x-show="!sidebarCollapsed">Perjalanan Dinas</p>

            {{-- Matriks Dinas --}}
            <a href="{{ route('perjalanan-dinas') }}"
               :title="sidebarCollapsed ? 'Matriks Dinas' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Matriks Dinas</span>
            </a>
            @endcan

            {{-- Arsip Group --}}
            @can('arsip.view')
            <p class="px-3 mt-4 mb-2 text-xs font-semibold tracking-wider text-indigo-300 uppercase" x-show="!sidebarCollapsed">Arsip</p>

            <a href="{{ route('arsip.index') }}"
               :title="sidebarCollapsed ? 'Arsip Link' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Arsip Link</span>
            </a>
            @endcan

            {{-- Master Group --}}
            @if(auth()->user()->hasAnyPermission(['pegawai.view','kode-kegiatan.view']))
            <p class="px-3 mt-4 mb-2 text-xs font-semibold tracking-wider text-indigo-300 uppercase" x-show="!sidebarCollapsed">Master</p>
            @endif

            {{-- Pegawai --}}
            @can('pegawai.view')
            <a href="{{ route('pegawai') }}"
               :title="sidebarCollapsed ? 'Pegawai' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Pegawai</span>
            </a>
            @endcan
            ...
            <a href="{{ route('kode-kegiatan') }}"
               :title="sidebarCollapsed ? 'Kode Kegiatan BOK' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Kode Kegiatan BOK</span>
            </a>
            @endcan

            {{-- Sistem Group --}}
            @if(auth()->user()->hasAnyPermission(['settings.view','log-aktivitas.view','roles.view']))
            <p class="px-3 mt-4 mb-2 text-xs font-semibold tracking-wider text-indigo-300 uppercase" x-show="!sidebarCollapsed">Sistem</p>
            @endif
            ...
            <a href="{{ route('settings') }}"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Pengaturan</span>
            </a>
            @endcan
            ...
            <a href="{{ route('roles.index') }}"
               :title="sidebarCollapsed ? 'Manajemen Role' : ''"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Manajemen Role</span>
            </a>
            @endcan
            ...
            <a href="{{ route('log-aktivitas.index') }}"
               ...
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Log Aktivitas</span>
            </a>
            @endcan

            {{-- Changelog --}}
            <a href="{{ route('changelog.index') }}"
               :title="sidebarCollapsed ? 'Changelog' : ''"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('changelog.*') ? 'bg-white/15 text-white shadow-sm' : 'text-indigo-100 hover:bg-white/10 hover:text-white' }}"
               :class="sidebarCollapsed ? 'lg:justify-center lg:px-2' : ''">
                <svg class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke="currentColor">
                ...
                <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">Changelog</span>
            </a>
        </nav>

        {{-- Sidebar footer / user info --}}
        <div class="border-t border-white/10 py-4" :class="sidebarCollapsed ? 'px-2' : 'px-4'">
            <div class="flex items-center gap-3" :class="sidebarCollapsed ? 'lg:justify-center' : ''">
                ...
                <div class="min-w-0 flex-1" x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-150 delay-75" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
    ...
    {{-- Main content area --}}
    <div :class="sidebarCollapsed ? 'lg:pl-16' : 'lg:pl-64'" class="transition-all duration-200">
        {{-- Top bar --}}

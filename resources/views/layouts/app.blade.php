...
<body class="h-full font-[Inter] antialiased bg-gray-50" x-data="{ sidebarOpen: false }">
    ...
    >
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            <p class="px-3 mb-2 text-xs font-semibold tracking-wider text-indigo-300 uppercase">Menu Utama</p>
            ...
            <p class="px-3 mt-5 mb-2 text-xs font-semibold tracking-wider text-indigo-300 uppercase">Manajemen</p>
